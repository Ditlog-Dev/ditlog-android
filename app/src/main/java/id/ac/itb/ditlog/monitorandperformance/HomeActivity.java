...
public class HomeActivity extends AppCompatActivity {
    ...
    private static final String TAG_PENILAIAN = "penilaian";
    private static final String TAG_REALISASI = "realisasi";
